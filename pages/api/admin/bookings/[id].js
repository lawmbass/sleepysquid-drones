...
export default async function handler(req, res) {
  ...
  const expectedAuth = process.env.ADMIN_API_KEY || 'demo-api-key-for-development';
  
  // Allow demo key for development
  if (authHeader !== `Bearer ${expectedAuth}` && authHeader !== 'Bearer demo-api-key-for-development') {
