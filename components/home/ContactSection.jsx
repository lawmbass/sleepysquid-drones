          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-6">
                ...
                ></textarea>
                {errors.message && (
                  <p className="text-sm text-red-500 mt-1">Please enter your message</p>
                )}
              </div>
              ...
              <div className="space-y-6">
                {/* <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Drone Avenue, Skyview City, CA 90210</p>
                  </div>
                </div> */}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@sleepysquid.com</p>
                  </div>
                </div>
